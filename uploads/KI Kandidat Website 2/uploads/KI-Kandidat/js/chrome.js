...
(function(){
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-col">
            <a href="index.html" class="logo" style="margin-bottom:16px">
              <span class="logo-mark"><span>RG</span></span>
              <span>KI-Kandidat</span>
            </a>
            <p style="color:var(--fg-muted);font-size:14px;max-width:36ch;margin:0 0 24px 0">
              Software-Recruiting für den DACH-Mittelstand. KI, Talent-Pool, persönliche Betreuung — in einem System.
            </p>
            <div style="display:flex;gap:8px">
              <a href="#" class="btn btn-ghost" style="padding:8px 12px;font-size:12px">LinkedIn</a>
              <a href="#" class="btn btn-ghost" style="padding:8px 12px;font-size:12px">XING</a>
              <a href="#" class="btn btn-ghost" style="padding:8px 12px;font-size:12px">Kununu</a>
            </div>
          </div>
          <div class="footer-col">
            <h4>Plattform</h4>
        ...
        <div class="footer-bottom">
          ...
          <div style="display:flex;gap:24px">
            ...
            <a href="#">DSGVO-konform · Server in DE</a>
          </div>
        </div>
      </div>
    </footer>`;
  ...
  function applyTweaks(t) {
    ...
    if (t.theme) root.setAttribute('data-theme', t.theme === 'light' ? 'light' : '');
    if (t.accent) {
      const presets = {
