  ...
  function buildFooter() {
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><a href="karriereseiten.html">Karriereseiten</a></li>
        ...
        <div class="footer-bottom" style="justify-content:center;text-align:center;gap:14px 24px;padding-bottom:12px">
          <div>© 2026 KI-Kandidat GmbH. Alle Rechte vorbehalten.</div>
          <a class="footer-credit" href="https://webziger.de" target="_blank" rel="noopener noreferrer" aria-label="Generated by Webziger">
            <span>Generated by</span>
            <img src="assets/webziger-logo.png?v=footer1" alt="Webziger" width="40" height="20" loading="lazy" />
          </a>
